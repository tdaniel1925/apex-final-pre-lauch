-- ============================================================================
-- ADD BIO TO ATOMIC SIGNUP FUNCTION
-- Migration: 20260325000001
-- Purpose: Update create_distributor_atomic to accept bio parameter
--          for AI Voice Agent personalization
-- ============================================================================
...
CREATE OR REPLACE FUNCTION create_distributor_atomic(
  ...
  -- NEW: Bio for AI Voice Agent personalization
...
COMMENT ON FUNCTION create_distributor_atomic IS
  'Atomically creates a distributor with matrix placement. Uses advisory lock to prevent race conditions. Supports business/personal registration with address fields and bio for AI Voice Agent personalization.';
