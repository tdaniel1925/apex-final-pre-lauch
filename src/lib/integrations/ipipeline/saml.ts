...
// Mark Financial/Apex-specific constants (assigned by iPipeline)
const APEX_GAID = '2643';
const APEX_COMPANY_IDENTIFIER = '2643';
const APEX_CHANNEL_NAME = 'APEX';
const APEX_GROUPS = '02643-UsersGroup';
  ...
  <saml:Assertion xmlns:saml="urn:oasis:names:tc:SAML:2.0:assertion"
    ...
    <saml:AttributeStatement>
      <saml:Attribute Name="CompanyIdentifier" NameFormat="urn:oasis:names:tc:SAML:2.0:attrname-format:basic">
        <saml:AttributeValue>${APEX_COMPANY_IDENTIFIER}</saml:AttributeValue>
      </saml:Attribute>
      <saml:Attribute Name="ChannelName" NameFormat="urn:oasis:names:tc:SAML:2.0:attrname-format:basic">
        <saml:AttributeValue>${APEX_CHANNEL_NAME}</saml:AttributeValue>
      </saml:Attribute>
      ...
      <saml:Attribute Name="Groups" NameFormat="urn:oasis:names:tc:SAML:2.0:attrname-format:basic">
        <saml:AttributeValue>${APEX_GROUPS}</saml:AttributeValue>
      </saml:Attribute>
