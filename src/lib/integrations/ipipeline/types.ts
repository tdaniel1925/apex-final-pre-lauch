 ...
 *
 * Based on Mark Financial SAML2 Guide (GAID: 2643)
 */
...
export interface IPipelineConfig {
  // Mark Financial-specific identifiers (assigned by iPipeline)
  gaid: string;           // 2643
  companyIdentifier: string; // 2643
  channelName: string;    // APEX
  groups: string;         // 02643-UsersGroup
...
export const IPIPELINE_ENDPOINTS = {
  ...
  // RelayState URLs (product-specific, GAID=2643 for Mark Financial/Apex)
  products: {
    igo: {
      uat: 'https://pipepasstoigo-uat3.ipipeline.com/default.aspx?gaid=2643',
      production: 'https://pipepasstoigo.ipipeline.com/default.aspx?gaid=2643',
    },
    lifepipe: {
      uat: 'https://quote-uat.ipipeline.com/LTSearch.aspx?GAID=2643',
      production: 'https://quote.ipipeline.com/LTSearch.aspx?GAID=2643',
    },
    formspipe: {
      uat: 'https://formspipe-uat.ipipeline.com/?GAID=2643',
      production: 'https://formspipe.ipipeline.com/?GAID=2643',
    },
    xrae: {
      uat: 'https://xrae-uat.ipipeline.com/RSAGateway?gaid=2643',
      production: 'https://xrae.ipipeline.com/RSAGateway?gaid=2643',
    },
    productinfo: {
      uat: 'https://prodinfo-uat.ipipeline.com/productlist?GAID=2643',
      production: 'https://prodinfo.ipipeline.com/productlist?GAID=2643',
    },
  },
