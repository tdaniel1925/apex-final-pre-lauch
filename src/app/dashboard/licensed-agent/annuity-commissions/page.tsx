// =============================================
// Annuity Commission Rates by Level - COMPLETE
// Shows ALL 74 annuity products with search and filter
// =============================================
...
import annuityData from '@/data/annuity-commissions.json';

export const metadata = {
  title: 'Annuity Commissions - Licensed Agent Tools',
  description: 'View all annuity commission rates by agent level',
};

export default async function AnnuityCommissionsPage() {
  ...
  const levels = ['New Hire', 'Pre-Associate', 'Associate', 'Agent', 'GA', 'MGA'];

  return (
    <div className="p-6">
      {/* Page Header */}
      <div className="mb-6">
        <h1 className="text-3xl font-bold text-gray-900">Annuity Commission Rates</h1>
        <p className="text-sm text-gray-600 mt-2">
          Complete commission structure for all {annuityData.length} annuity products
        </p>
      </div>
      ...
      <div className="mt-4 text-center">
        <a
          href="/Apex Annuity Grid by levels.xlsx"
          download
