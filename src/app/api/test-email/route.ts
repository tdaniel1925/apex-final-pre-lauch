    ...
    <tr>
      <td align="center">
        <table width="600" cellpadding="0" cellspacing="0" style="background-color: #ffffff; border-radius: 8px; overflow: hidden; box-shadow: 0 2px 8px rgba(0,0,0,0.1);">
          <tr>
            <td style="background: linear-gradient(135deg, #1B3A7D 0%, #1e3557 100%); padding: 40px 30px; text-align: center;">
          ...
          <tr>
            <td style="padding: 40px 30px;">
              <h2 style="color: #1B3A7D; font-size: 24px; margin: 0 0 20px 0;">Thank You for Registering!</h2>
              ...
              <h3 style="color: #1B3A7D; font-size: 20px; margin: 0 0 15px 0;">What Happens Next?</h3>
              <table cellpadding="0" cellspacing="0" style="margin-bottom: 20px; width: 100%;">
                <tr>
                  <td style="vertical-align: top; padding-right: 15px; width: 40px;">
                    <div style="width: 40px; height: 40px; background-color: #1B3A7D; border-radius: 50%; color: #ffffff; font-weight: bold; font-size: 18px; text-align: center; line-height: 40px;">1</div>
                  </td>
                  <td style="vertical-align: top;">
                    <h4 style="color: #1B3A7D; font-size: 18px; margin: 0 0 8px 0;">Back Office Access (Within 48 Hours)</h4>
              ...
              <table cellpadding="0" cellspacing="0" style="margin-bottom: 20px; width: 100%;">
                <tr>
                  <td style="vertical-align: top; padding-right: 15px; width: 40px;">
                    <div style="width: 40px; height: 40px; background-color: #1B3A7D; border-radius: 50%; color: #ffffff; font-weight: bold; font-size: 18px; text-align: center; line-height: 40px;">2</div>
                  </td>
                  <td style="vertical-align: top;">
                    <h4 style="color: #1B3A7D; font-size: 18px; margin: 0 0 8px 0;">Next Week's Training</h4>
              ...
              <div style="height: 1px; background-color: #e5e5e5; margin: 30px 0;"></div>
              <table cellpadding="0" cellspacing="0" width="100%" style="background-color: #f8f9fa; border-left: 4px solid #1B3A7D; padding: 20px; margin: 20px 0;">
                <tr>
                  <td>
                    <h4 style="color: #1B3A7D; font-size: 18px; margin: 0 0 10px 0;">💡 In the Meantime...</h4>
              ...
              <p style="color: #333333; font-size: 16px; line-height: 1.8; margin: 0 0 30px 0;">
                <strong style="color: #1B3A7D;">📧 Email:</strong> <a href="mailto:support@reachtheapex.net" style="color: #1B3A7D; text-decoration: none;">support@reachtheapex.net</a><br>
                <strong style="color: #1B3A7D;">📞 Phone:</strong> <a href="tel:281-600-4000" style="color: #1B3A7D; text-decoration: none;">281-600-4000</a>
              </p>
          ...
          <tr>
            <td style="background-color: #f8f9fa; padding: 30px; text-align: center; border-top: 1px solid #e5e5e5;">
              ...
              <p style="margin: 0;">
                <a href="https://reachtheapex.net" style="color: #1B3A7D; text-decoration: none; font-size: 14px; margin: 0 10px;">Visit Website</a>
                <span style="color: #cccccc;">|</span>
                <a href="https://reachtheapex.net/apex-vision" style="color: #1B3A7D; text-decoration: none; font-size: 14px; margin: 0 10px;">Our Vision</a>
              </p>
            </td>
          </tr>
        </table>
