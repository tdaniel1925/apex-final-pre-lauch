      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {stats.map((stat, index) => (
            <div
              key={index}
              className="bg-white rounded-2xl p-8 text-center hover:shadow-xl transition-shadow border border-[#1B3A7D]/10"
            >
              <div className="mb-2">
                <span className="text-sm text-[#C7181F] font-medium uppercase tracking-wide">
                  {stat.label}
                </span>
              </div>
              <h3 className="text-5xl md:text-6xl font-bold text-[#1B3A7D] mb-4">
                {stat.value}
              </h3>
        ...
        <div className="mt-12 bg-white rounded-2xl p-8 shadow-sm border border-[#1B3A7D]/10">
          <div className="flex flex-col md:flex-row items-center justify-between gap-6">
            ...
            <div className="flex items-center gap-4 shrink-0">
              <div className="flex gap-1 text-[#C7181F]">
                {[...Array(5)].map((_, i) => (
