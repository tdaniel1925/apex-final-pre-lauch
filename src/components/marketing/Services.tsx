      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
          {services.map((service, index) => (
            ...
            >
              <div className="mb-6">
                <div className="w-16 h-16 bg-[#C7181F]/10 rounded-xl flex items-center justify-center group-hover:bg-[#C7181F] transition-colors">
                  <Image src={service.icon} alt={service.title} width={32} height={32} />
                </div>
              </div>
              <h3 className="text-2xl font-bold text-[#1B3A7D] mb-4">
                {service.title}
              </h3>
              <p className="text-[#4B5563] mb-6">{service.description}</p>
              <Link
                href={service.link}
                className="text-[#C7181F] font-semibold hover:text-[#1B3A7D] transition-colors inline-flex items-center gap-2"
              >
                Learn More
          ...
          {/* Contact CTA Box */}
          <div className="bg-gradient-to-br from-[#C7181F] to-[#1B3A7D] rounded-2xl p-8 text-white flex flex-col justify-between">
            <div className="mb-6">
        ...
        <div className="text-center">
          <p className="text-lg text-[#4B5563]">
            <span className="text-[#C7181F] font-semibold">Free</span> Let's make something great work together -{' '}
            <Link href="/services" className="text-[#C7181F] font-semibold hover:underline">
              View all services.
            </Link>
          </p>
        </div>
