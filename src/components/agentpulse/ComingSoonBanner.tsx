...
export default function ComingSoonBanner() {
  return (
    <div className="bg-gradient-to-r from-[#1B3A7D] to-[#1e3555] text-white">
        ...
        <div className="flex items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-2">
            <Link
              ...
              className="px-4 py-2 bg-white text-[#1B3A7D] font-semibold rounded-lg hover:bg-blue-50 transition-colors text-sm whitespace-nowrap"
            >
              Preview Features
            </Link>
          </div>
