      ...
      items: [
        {
          ...
          submenu: [
            ...
            { name: 'Matrix', href: '/dashboard/compensation/matrix' },
            { name: 'Matching', href: '/dashboard/compensation/matching' },
            { name: 'Override', href: '/dashboard/compensation/override' },
            { name: 'Fast Start', href: '/dashboard/compensation/fast-start' },
            { name: 'CAB', href: '/dashboard/compensation/customer-milestones' },
            { name: 'Retention', href: '/dashboard/compensation/customer-retention' },
