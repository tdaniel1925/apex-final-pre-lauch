...
export default function Sidebar({ isLicensedAgent = true }: SidebarProps) {
  ...
  const navigation: NavSection[] = [
    ...
    // SECTION 3: BUSINESS CENTER ($39/mo Premium Features)
    {
      section: 'business-center',
      sectionTitle: 'Business Center',
      items: [
        {
          ...
          submenu: [
            ...
            },
            {
              ...
              href: '/dashboard/business-center/ai-nurture',
              icon: (
                <svg className="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      items: [
        {
          ...
          submenu: [
            ...
            {
              name: 'Annuity Commissions',
              href: '/dashboard/licensed-agent/annuity-commissions',
              icon: (
                <svg className="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
                </svg>
            ...
            {
              name: 'Life Commissions',
              href: '/dashboard/licensed-agent/life-commissions',
              icon: (
                <svg className="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z" />
                </svg>
