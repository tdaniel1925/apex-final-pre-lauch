    ...
    <div className="bg-white rounded-lg shadow-sm border border-slate-200">
      ...
      <div className="p-3 sm:p-4 border-b border-slate-200">
        <div className="flex items-center gap-2 flex-wrap">
          ...
          <h3 className="font-semibold text-slate-900 text-sm sm:text-base">AI Assistant</h3>
          ...
          {isTrialExpired && (
            <span className="ml-auto text-xs bg-red-100 text-red-800 px-2 py-1 rounded-full font-medium whitespace-nowrap">
              Trial Ended
            </span>
          )}
        </div>
      ...
      {/* Phone Number */}
      <div className="p-4 sm:p-5 bg-gradient-to-br from-blue-600 to-blue-800">
        ...
        <a
          ...
          className="text-xl sm:text-2xl font-bold text-white hover:text-blue-100 transition block break-all"
        >
      ...
      <div className="grid grid-cols-2 gap-px bg-slate-200">
        ...
        <div className="bg-white p-3 sm:p-4">
          <div className="flex items-center gap-1.5 sm:gap-2 mb-1">
            <Clock className={`w-3.5 h-3.5 sm:w-4 sm:h-4 ${isLowMinutes ? 'text-red-600' : 'text-slate-600'}`} />
            <div className="text-xs text-slate-600 font-medium">Minutes Left</div>
          </div>
          <div className={`text-xl sm:text-2xl font-bold ${isLowMinutes ? 'text-red-600' : 'text-slate-900'}`}>
        ...
        <div className="bg-white p-3 sm:p-4">
          ...
          <div className={`text-xl sm:text-2xl font-bold ${isTrialExpired ? 'text-red-600' : 'text-slate-900'}`}>
            {timeRemaining}
          </div>
          {isTrialExpired && (
      ...
      {(isTrialExpired || isLowMinutes) && (
        <div className="p-3 sm:p-4 bg-slate-50 border-t border-slate-200">
          <Link
            ...
            className="block text-center bg-blue-600 text-white px-4 py-2.5 rounded-lg text-sm font-medium hover:bg-blue-700 transition min-h-[44px] flex items-center justify-center"
          >
