    ...
    <aside className="w-52 bg-gray-900 text-white h-screen sticky top-0 flex flex-col">
      ...
      <div className="flex-1 overflow-y-auto px-3">
        <nav className="space-y-1">
          ...
          <div className="mt-4">
            ...
            {teamOpen && (
              <div className="mt-0.5 space-y-0.5">
                ...
                <Link href="/admin/genealogy" className={`flex items-center gap-2 px-3 py-2 rounded-md transition-colors ${pathname === '/admin/genealogy' ? 'bg-blue-600 text-white' : 'text-gray-300 hover:bg-gray-800 hover:text-white'}`}>
                  <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 7v10a2 2 0 002 2h14a2 2 0 002-2V9a2 2 0 00-2-2h-6l-2-2H5a2 2 0 00-2 2z" /></svg>
                  <span className="font-medium text-xs">Genealogy Tree</span>
                </Link>
                <Link href="/admin/matrix" className={`flex items-center gap-2 px-3 py-2 rounded-md transition-colors ${pathname === '/admin/matrix' ? 'bg-blue-600 text-white' : 'text-gray-300 hover:bg-gray-800 hover:text-white'}`}>
                  ...
                  <span className="font-medium text-xs">Matrix View</span>
                </Link>
                <Link href="/admin/prospects" className={`flex items-center gap-2 px-3 py-2 rounded-md transition-colors ${pathname === '/admin/prospects' ? 'bg-blue-600 text-white' : 'text-gray-300 hover:bg-gray-800 hover:text-white'}`}>
                  <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z" /></svg>
                  <span className="font-medium text-xs">Prospects</span>
                </Link>
              </div>
            )}
          </div>
          ...
          <div className="mt-3">
            ...
            {compOpen && (
              <div className="mt-0.5 space-y-0.5">
                ...
                <Link href="/admin/payouts" className={`flex items-center gap-2 px-3 py-2 rounded-md transition-colors ${pathname === '/admin/payouts' ? 'bg-blue-600 text-white' : 'text-gray-300 hover:bg-gray-800 hover:text-white'}`}>
                  <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17 9V7a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2m2 4h10a2 2 0 002-2v-6a2 2 0 00-2-2H9a2 2 0 00-2 2v6a2 2 0 002 2zm7-5a2 2 0 11-4 0 2 2 0 014 0z" /></svg>
                  <span className="font-medium text-xs">Payouts</span>
                </Link>
              </div>
            )}
          </div>
          ...
          <div className="mt-3">
            <button onClick={() => setMarketingOpen(!marketingOpen)} className="flex items-center gap-2 w-full px-3 py-1.5 text-gray-400 hover:text-white transition-colors">
              <ChevronIcon isOpen={marketingOpen} />
              <span className="text-[10px] font-bold uppercase tracking-wider">Marketing</span>
            </button>
            {marketingOpen && (
              <div className="mt-0.5 space-y-0.5">
                <Link href="/admin/email-templates" className={`flex items-center gap-2 px-3 py-2 rounded-md transition-colors ${pathname === '/admin/email-templates' ? 'bg-blue-600 text-white' : 'text-gray-300 hover:bg-gray-800 hover:text-white'}`}>
                  <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" /></svg>
                  <span className="font-medium text-xs">Email Templates</span>
                </Link>
                <Link href="/admin/business-card-templates" className={`flex items-center gap-2 px-3 py-2 rounded-md transition-colors ${pathname === '/admin/business-card-templates' ? 'bg-blue-600 text-white' : 'text-gray-300 hover:bg-gray-800 hover:text-white'}`}>
                  <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 10h18M7 15h1m4 0h1m-7 4h12a3 3 0 003-3V8a3 3 0 00-3-3H6a3 3 0 00-3 3v8a3 3 0 003 3z" /></svg>
                  <span className="font-medium text-xs">Business Cards</span>
                </Link>
                <Link href="/admin/social-content" className={`flex items-center gap-2 px-3 py-2 rounded-md transition-colors ${pathname === '/admin/social-content' ? 'bg-blue-600 text-white' : 'text-gray-300 hover:bg-gray-800 hover:text-white'}`}>
                  <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M7 8h10M7 12h4m1 8l-4-4H5a2 2 0 01-2-2V6a2 2 0 012-2h14a2 2 0 012 2v8a2 2 0 01-2 2h-3l-4 4z" /></svg>
                  <span className="font-medium text-xs">Social Content</span>
                </Link>
              </div>
            )}
          </div>
          ...
          <div className="mt-3">
            <button onClick={() => setTrainingOpen(!trainingOpen)} className="flex items-center gap-2 w-full px-3 py-1.5 text-gray-400 hover:text-white transition-colors">
              <ChevronIcon isOpen={trainingOpen} />
              <span className="text-[10px] font-bold uppercase tracking-wider">Training</span>
            </button>
            {trainingOpen && (
              <div className="mt-0.5 space-y-0.5">
                <Link href="/admin/training-audio" className={`flex items-center gap-2 px-3 py-2 rounded-md transition-colors ${pathname === '/admin/training-audio' ? 'bg-blue-600 text-white' : 'text-gray-300 hover:bg-gray-800 hover:text-white'}`}>
                  <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 11a7 7 0 01-7 7m0 0a7 7 0 01-7-7m7 7v4m0 0H8m4 0h4m-4-8a3 3 0 01-3-3V5a3 3 0 116 0v6a3 3 0 01-3 3z" /></svg>
                  <span className="font-medium text-xs">Training Audio</span>
                </Link>
              </div>
            )}
          </div>

          <div className="mt-6 pt-3 border-t border-gray-800 space-y-0.5">
            <Link href="/admin/reports" className={`flex items-center gap-2 px-3 py-2 rounded-md transition-colors ${pathname === '/admin/reports' ? 'bg-blue-600 text-white' : 'text-gray-300 hover:bg-gray-800 hover:text-white'}`}>
              <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 17v-2m3 2v-4m3 4v-6m2 10H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" /></svg>
              <span className="font-medium text-xs">Reports</span>
            </Link>
            <Link href="/admin/activity" className={`flex items-center gap-2 px-3 py-2 rounded-md transition-colors ${pathname === '/admin/activity' ? 'bg-blue-600 text-white' : 'text-gray-300 hover:bg-gray-800 hover:text-white'}`}>
              <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-3 7h3m-3 4h3m-6-4h.01M9 16h.01" /></svg>
              <span className="font-medium text-xs">Activity Log</span>
            </Link>
            <Link href="/admin/settings" className={`flex items-center gap-2 px-3 py-2 rounded-md transition-colors ${pathname === '/admin/settings' ? 'bg-blue-600 text-white' : 'text-gray-300 hover:bg-gray-800 hover:text-white'}`}>
