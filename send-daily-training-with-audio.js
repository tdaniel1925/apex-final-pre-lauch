...
/**
 * Send Daily Training Email Sample WITH Audio
 *
 * Uses embedded audio player with demo audio file
 */
...
// Using a demo audio URL (2-minute sample)
// In production, this will be your actual hosted audio files
  ...
  html: `
    <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px; background: #f8fafc;">
      ...
      <div style="background: white; padding: 40px; border-radius: 0 0 12px 12px; box-shadow: 0 4px 6px rgba(0,0,0,0.1);">
        ...
        <!-- ACTUAL AUDIO PLAYER -->
        <div style="background: linear-gradient(135deg, #1e293b 0%, #334155 100%); padding: 25px; border-radius: 12px; margin: 20px 0; text-align: center;">
          <div style="font-size: 48px; margin-bottom: 15px;">🎧</div>
          <p style="margin: 0 0 20px 0; font-size: 18px; font-weight: bold; color: white;">Listen to Today's Training</p>

          <!-- HTML5 Audio Player -->
          <audio controls style="width: 100%; max-width: 400px; margin: 10px auto; display: block;">
        ...
        <div style="margin-top: 20px; padding: 15px; background: #dbeafe; border-radius: 8px; border-left: 4px solid #3b82f6;">
          <p style="margin: 0; font-size: 13px; color: #1e40af;">
            <strong>📌 Demo Note:</strong> This sample uses placeholder audio to show the embedded player. Production emails will have professionally narrated 2-minute training audio for each day.
          </p>
        </div>
      </div>
      ...
      <div style="text-align: center; margin-top: 30px; padding: 20px;">
        <p style="font-size: 12px; color: #94a3b8; margin: 0;">
          This is a sample of our Daily 2-Minute Training series with embedded audio.<br>
...
async function sendSample() {
  console.log('📧 Sending Daily Training Sample Email WITH AUDIO...\n');
  ...
  try {
    ...
    const result = await resend.emails.send({
      ...
      subject: `[SAMPLE WITH AUDIO] ${sampleEmail.subject}`,
    ...
    if (result.error) {
      ...
      console.log('📋 Check your inbox - this version has an EMBEDDED AUDIO PLAYER!');
      console.log('🎧 Click play to hear the training (demo audio).');
      console.log('💡 In production, each day will have custom 2-minute narration.\n');
      console.log('📝 Note: Some email clients may not support HTML5 audio.');
      console.log('   Gmail web: ✅ Works');
      console.log('   Outlook web: ✅ Works');
      console.log('   Apple Mail: ✅ Works');
      console.log('   Mobile Gmail: ⚠️  May require "View full message"');
    }
