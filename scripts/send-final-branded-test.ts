// =============================================
// Send Final Branded Email Test
// V2 Template with proper email client support
// =============================================

import { Resend } from 'resend';
import * as dotenv from 'dotenv';
import { createApexEmailTemplate } from '../src/lib/email/apex-email-template-v2';
...
async function sendFinalTest() {
  console.log('📧 Sending FINAL Branded Pre-Launch Email (V2 Template)...\n');
  ...
  const emailContent = `
    ...
    <div class="info-box">
      ...
      <p><a href="mailto:support@reachtheapex.net" style="color: #1B3A7D; font-weight: 700; font-size: 16px;">support@reachtheapex.net</a></p>
  ...
  try {
    const { data, error } = await resend.emails.send({
      ...
      subject: '[FINAL V2] Thank You for Being Part of Our Pre-Launch Journey! 🌟',
      html: htmlContent,
    });
    ...
    console.log('✅ FINAL branded email sent successfully!');
    console.log('\nEmail Details:');
    console.log('   To: tdaniel@botmakers.ai');
    console.log('   From: Apex Affinity Group <theapex@theapexway.net>');
    console.log('   Subject: [FINAL V2] Thank You for Being Part of Our Pre-Launch Journey! 🌟');
    console.log('   Template: V2 - Email-client optimized');
    console.log('\n   ✨ Features:');
    console.log('   - Navy blue header with grid pattern');
    console.log('   - Larger centered logo (250px)');
    console.log('   - NO badge pill');
    console.log('   - Navy blue footer with grid pattern');
    console.log('   - Inline styles for email client compatibility');
    ...
    console.log('\n📧 Check tdaniel@botmakers.ai inbox for the FINAL VERSION!');
