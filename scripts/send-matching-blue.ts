// =============================================
// Send Email with Matching Blue Colors from Logo
// Using Apex brand blue: #2B4C7E
// =============================================
...
async function sendMatchingBlue() {
  console.log('📧 Sending Email with Matching Blue Colors...\n');
...
<body style="margin: 0; padding: 0; background-color: #F0F2F8;">
    ...
    <tr>
      <td align="center">
        ...
        <table width="600" cellpadding="0" cellspacing="0" border="0" style="background-color: #ffffff;">
          ...
          <!-- HEADER - WHITE Background with Color Logo -->
          <tr>
          ...
          <tr>
            <td style="padding: 40px 32px; color: #4A5068; font-family: Arial, sans-serif; font-size: 15px; line-height: 1.7;">
              ...
              <p style="margin: 0 0 16px 0;"><strong style="color: #2B4C7E;">Thank you for being a valued member of the Apex Affinity Group family!</strong></p>
              ...
              <h2 style="font-family: Georgia, serif; font-size: 22px; line-height: 1.3; color: #2B4C7E; margin: 32px 0 12px 0;">Why You Were Chosen</h2>
              ...
              <h2 style="font-family: Georgia, serif; font-size: 22px; line-height: 1.3; color: #2B4C7E; margin: 32px 0 12px 0;">What to Expect During Pre-Launch</h2>
              ...
              <h2 style="font-family: Georgia, serif; font-size: 22px; line-height: 1.3; color: #2B4C7E; margin: 32px 0 12px 0;">We're Here to Support You 24/7</h2>
              ...
              <!-- Support Info Box -->
              <table width="100%" cellpadding="24" cellspacing="0" border="0" style="background-color: #F0F2F8; border-left: 4px solid #2B4C7E; border-radius: 8px; margin: 24px 0;">
                <tr>
                  <td>
                    <h3 style="font-size: 16px; font-weight: 700; color: #2B4C7E; margin: 0 0 10px 0;">📞 24/7 AI Hotline</h3>
                    ...
                    <h3 style="font-size: 16px; font-weight: 700; color: #2B4C7E; margin: 20px 0 10px 0;">📧 Email Support</h3>
                    <p style="margin: 0 0 12px 0;"><a href="mailto:support@reachtheapex.net" style="color: #2B4C7E; font-weight: 700; font-size: 16px; text-decoration: none;">support@reachtheapex.net</a></p>
              ...
              <h2 style="font-family: Georgia, serif; font-size: 22px; line-height: 1.3; color: #2B4C7E; margin: 32px 0 12px 0;">Moving Forward Together</h2>
              ...
              <h2 style="font-family: Georgia, serif; font-size: 22px; line-height: 1.3; color: #2B4C7E; margin: 32px 0 12px 0;">Questions?</h2>
          ...
          <!-- FOOTER - Navy Blue with Grid Pattern & CAN-SPAM Compliance -->
          <tr>
            <td align="center" bgcolor="#0A1A3F" style="padding: 32px 24px; background-color: #0A1A3F; background-image: repeating-linear-gradient(0deg, transparent, transparent 49px, rgba(255,255,255,0.15) 49px, rgba(255,255,255,0.15) 50px), repeating-linear-gradient(90deg, transparent, transparent 49px, rgba(255,255,255,0.15) 49px, rgba(255,255,255,0.15) 50px); border-top: 1px solid rgba(255,255,255,0.08);">
              ...
              <p style="margin: 16px 0 0 0; font-size: 11px;">
                <a href="{{unsubscribe_url}}" style="color: #FF4C52; text-decoration: underline;">Unsubscribe</a> |
                <a href="https://reachtheapex.net/preferences" style="color: #FF4C52; text-decoration: underline;">Email Preferences</a>
              </p>

              <p style="margin: 12px 0 0 0; font-size: 10px; color: rgba(255,255,255,0.3); line-height: 1.5;">
                You are receiving this email because you are a member of Apex Affinity Group. If you no longer wish to receive these emails, you can unsubscribe at any time.
              </p>
  ...
  try {
    const { data, error } = await resend.emails.send({
      ...
      subject: '🎨 Matching Brand Colors - Pre-Launch Thank You!',
      html: htmlContent,
    });
    ...
    console.log('✅ Email with Matching Brand Blue sent!');
    console.log('\n🎨 Color Updates:');
    console.log('   ✅ All headings now use Apex brand blue: #2B4C7E');
    console.log('   ✅ Strong text uses brand blue: #2B4C7E');
    console.log('   ✅ Support box border uses brand blue: #2B4C7E');
    console.log('   ✅ Email link uses brand blue: #2B4C7E');
    console.log('   ✅ Red accent color stays: #C7181F (for phone & italic text)');
    console.log('\n   Email ID:', data?.id);
    console.log('\n📧 CHECK YOUR INBOX - Subject: "🎨 Matching Brand Colors"');
