// =============================================
// Send Final Email with Grid Pattern and White Logo
// =============================================
...
async function sendFinalWithGrid() {
  console.log('📧 Sending Final Email with Grid Pattern and White Logo...\n');
...
<body style="margin: 0; padding: 0; background-color: #F0F2F8;">
    ...
    <tr>
      <td align="center">
        ...
        <table width="600" cellpadding="0" cellspacing="0" border="0" style="background-color: #ffffff;">
          ...
          <!-- HEADER - Navy Blue with Visible Grid Pattern -->
          <tr>
            <td align="center" bgcolor="#0A1A3F" style="padding: 60px 24px; background-color: #0A1A3F; background-image: repeating-linear-gradient(0deg, transparent, transparent 49px, rgba(255,255,255,0.08) 49px, rgba(255,255,255,0.08) 50px), repeating-linear-gradient(90deg, transparent, transparent 49px, rgba(255,255,255,0.08) 49px, rgba(255,255,255,0.08) 50px);">
              <!-- White Logo from Optive -->
              <img src="https://reachtheapex.net/optive/images/logo-white.svg" alt="Apex Affinity Group" width="320" style="display: block; max-width: 320px; height: auto;" />
            </td>
          </tr>
          ...
          <!-- FOOTER - Navy Blue with Visible Grid Pattern -->
          <tr>
            <td align="center" bgcolor="#0A1A3F" style="padding: 32px 24px; background-color: #0A1A3F; background-image: repeating-linear-gradient(0deg, transparent, transparent 49px, rgba(255,255,255,0.08) 49px, rgba(255,255,255,0.08) 50px), repeating-linear-gradient(90deg, transparent, transparent 49px, rgba(255,255,255,0.08) 49px, rgba(255,255,255,0.08) 50px); border-top: 1px solid rgba(255,255,255,0.08);">
  ...
  try {
    const { data, error } = await resend.emails.send({
      ...
      subject: '✨ FINAL with Grid & White Logo - Pre-Launch Thank You!',
      html: htmlContent,
    });
    ...
    console.log('✅ FINAL email with grid pattern and white logo sent!');
    console.log('\nThis version has:');
    console.log('   ✅ White Optive logo (320px width)');
    console.log('   ✅ VISIBLE grid pattern in header (50px squares)');
    console.log('   ✅ VISIBLE grid pattern in footer (50px squares)');
    console.log('   ✅ Navy blue header (#0A1A3F)');
    console.log('   ✅ Navy blue footer (#0A1A3F)');
    console.log('   ✅ NO badge pill');
    console.log('\n   Email ID:', data?.id);
    console.log('\n📧 CHECK YOUR INBOX - Subject: "✨ FINAL with Grid & White Logo"');
