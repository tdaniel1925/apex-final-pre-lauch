// =============================================
// Send Email with CAN-SPAM Compliance Footer
// =============================================
...
async function sendWithCompliance() {
  console.log('📧 Sending Email with CAN-SPAM Compliance Footer...\n');
...
<body style="margin: 0; padding: 0; background-color: #F0F2F8;">
    ...
    <tr>
      <td align="center">
        ...
        <table width="600" cellpadding="0" cellspacing="0" border="0" style="background-color: #ffffff;">
          ...
          <!-- FOOTER - Navy Blue with Grid Pattern -->
          <tr>
  ...
  try {
    const { data, error } = await resend.emails.send({
      ...
      subject: '📧 CAN-SPAM Compliant - Pre-Launch Thank You!',
      html: htmlContent,
    });
    ...
    console.log('✅ Email with CAN-SPAM Compliance sent!');
    console.log('\nThis version has:');
    console.log('   ✅ Company physical address (required by CAN-SPAM)');
    console.log('   ✅ Unsubscribe link');
    console.log('   ✅ Email preferences link');
    console.log('   ✅ Reason for receiving email');
    console.log('   ✅ All previous features (white logo, grid, reduced padding)');
    console.log('\n   ⚠️  NOTE: You need to replace [Your Street Address] with actual address');
    console.log('\n   Email ID:', data?.id);
    console.log('\n📧 CHECK YOUR INBOX - Subject: "📧 CAN-SPAM Compliant"');
