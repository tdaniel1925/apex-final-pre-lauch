// =============================================
// Send Simple Table-Based Email Test
// Guaranteed to work in ALL email clients
// =============================================
...
async function sendSimpleTest() {
  console.log('📧 Sending SIMPLE Table-Based Email...\n');

  // Pure table-based HTML with inline styles - works in ALL email clients
  const htmlContent = `
<!DOCTYPE html>
<html>
<head>
...
<body style="margin: 0; padding: 0; background-color: #F0F2F8;">
    ...
    <tr>
      <td align="center">
        ...
        <table width="600" cellpadding="0" cellspacing="0" border="0" style="background-color: #ffffff;">
          ...
          <tr>
            <td align="center" bgcolor="#0A1A3F" style="padding: 60px 24px; background-color: #0A1A3F;">
              <!-- Logo - Larger and Centered -->
              <img src="https://reachtheapex.net/apex-logo.png" alt="Apex Affinity Group" width="280" style="display: block; max-width: 280px; height: auto;" />
            </td>
          </tr>
          ...
          <!-- FOOTER - Navy Blue -->
          <tr>
            <td align="center" bgcolor="#0A1A3F" style="padding: 32px 24px; background-color: #0A1A3F; border-top: 1px solid rgba(255,255,255,0.08);">
  ...
  try {
    const { data, error } = await resend.emails.send({
      ...
      subject: '✅ WORKING VERSION - Thank You Pre-Launch! 🌟',
      html: htmlContent,
    });
    ...
    console.log('✅ SIMPLE table-based email sent!');
    console.log('\nThis version WILL have:');
    console.log('   ✅ Navy blue header (#0A1A3F)');
    console.log('   ✅ Navy blue footer (#0A1A3F)');
    console.log('   ✅ Larger logo (280px width)');
    console.log('   ✅ Centered logo');
    console.log('   ✅ NO badge pill');
    console.log('   ✅ Table-based layout (works in ALL email clients)');
    console.log('\n   Email ID:', data?.id);
    console.log('\n📧 CHECK YOUR INBOX NOW - Subject: "✅ WORKING VERSION"');
