// =============================================
// Send Email with Reduced Header Padding
// =============================================
...
async function sendReducedPaddingTest() {
  console.log('📧 Sending Email with Reduced Header Padding...\n');
...
<body style="margin: 0; padding: 0; background-color: #F0F2F8;">
    ...
    <tr>
      <td align="center">
        ...
        <table width="600" cellpadding="0" cellspacing="0" border="0" style="background-color: #ffffff;">
          ...
          <!-- HEADER - Navy Blue with REDUCED Padding (30px instead of 60px) -->
          <tr>
  ...
  try {
    const { data, error } = await resend.emails.send({
      ...
      subject: '✨ FINAL - Reduced Padding - Pre-Launch Thank You!',
      html: htmlContent,
    });
    ...
    console.log('✅ Email with Reduced Header Padding sent!');
    console.log('\nThis version has:');
    console.log('   ✅ White PNG logo');
    console.log('   ✅ REDUCED header padding: 30px (was 60px)');
    console.log('   ✅ Less space above and below logo');
    console.log('   ✅ Visible grid pattern in header & footer');
    console.log('   ✅ Navy blue backgrounds (#0A1A3F)');
    console.log('   ✅ 320px logo width');
    console.log('\n   Email ID:', data?.id);
    console.log('\n📧 CHECK YOUR INBOX - Subject: "✨ FINAL - Reduced Padding"');
