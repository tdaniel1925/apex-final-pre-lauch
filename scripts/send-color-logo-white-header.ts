// =============================================
// Send Email with Color Logo and White Header
// =============================================
...
async function sendColorLogoWhiteHeader() {
  console.log('📧 Sending Email with Color Logo and White Header...\n');
...
<body style="margin: 0; padding: 0; background-color: #F0F2F8;">
        ...
        <table width="600" cellpadding="0" cellspacing="0" border="0" style="background-color: #ffffff;">
          ...
          <tr>
            <td align="center" bgcolor="#FFFFFF" style="padding: 30px 24px; background-color: #FFFFFF;">
              <!-- Full Color Logo -->
              <img src="https://reachtheapex.net/apex-logo-color.png" alt="Apex Affinity Group" width="320" style="display: block; max-width: 320px; height: auto;" />
            </td>
          </tr>
  ...
  try {
    const { data, error } = await resend.emails.send({
      ...
      subject: '🎨 Color Logo + White Header - Pre-Launch Thank You!',
      html: htmlContent,
    });
    ...
    console.log('✅ Email with Color Logo and White Header sent!');
    console.log('\n🎨 This version has:');
    console.log('   ✅ Full color Apex logo (320px)');
    console.log('   ✅ WHITE header background (no blue)');
    console.log('   ✅ Navy blue footer with grid pattern');
    console.log('   ✅ Full Apex address in footer');
    console.log('   ✅ CAN-SPAM compliance (unsubscribe links)');
    console.log('   ✅ Support info: Phone + Email');
    console.log('\n   Email ID:', data?.id);
    console.log('\n📧 CHECK YOUR INBOX - Subject: "🎨 Color Logo + White Header"');
