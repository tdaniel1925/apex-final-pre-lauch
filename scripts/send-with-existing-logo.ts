// =============================================
// Send Email with Existing Logo from Server
// =============================================
...
async function sendWithExistingLogo() {
  console.log('📧 Sending Email with Existing Server Logo...\n');
...
<body style="margin: 0; padding: 0; background-color: #F0F2F8;">
        ...
        <table width="600" cellpadding="0" cellspacing="0" border="0" style="background-color: #ffffff;">
          ...
          <tr>
            <td align="center" bgcolor="#FFFFFF" style="padding: 30px 24px; background-color: #FFFFFF;">
              <!-- Full Color Logo (using existing apex-logo.png) -->
          ...
          <tr>
            <td style="padding: 40px 32px; color: #4A5068; font-family: Arial, sans-serif; font-size: 15px; line-height: 1.7;">
              ...
              <p style="margin: 0 0 16px 0;">As one of our founding members, your feedback and experience during these early stages are invaluable. You're helping us build something truly special, and your insights will shape the future of Apex for thousands of come.</p>
  ...
  try {
    const { data, error } = await resend.emails.send({
      ...
      subject: '✅ FINAL TEMPLATE - Pre-Launch Thank You!',
      html: htmlContent,
    });
    ...
    console.log('✅ FINAL Email Template sent!');
    console.log('\n🎉 Using existing server logo (apex-logo.png)');
    console.log('   ✅ White header background');
    console.log('   ✅ Full color Apex logo (320px)');
    console.log('   ✅ Navy blue footer with grid');
    console.log('   ✅ Full address & CAN-SPAM compliance');
    console.log('   ✅ Support: (832) 909-1715 & support@reachtheapex.net');
    console.log('\n   Email ID:', data?.id);
    console.log('\n📧 CHECK YOUR INBOX - Subject: "✅ FINAL TEMPLATE"');
