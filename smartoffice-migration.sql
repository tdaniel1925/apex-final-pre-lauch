...
🚀 Applying SmartOffice Migration to Production

📡 Database: https://brejvdvzwshroxkkhmzy.supabase.co

📄 Migration file loaded
   → Path: C:\dev\1 - Apex Pre-Launch Site\supabase\migrations\20260321000001_smartoffice_integration.sql
   → Size: 10743 characters

⚠️  WARNING: About to execute SQL migration on production database!

This will create the following tables:
  - smartoffice_sync_config (with credentials)
  - smartoffice_agents
...
⚠️  IMPORTANT: This script cannot execute raw SQL via Supabase client.
   → Supabase client does not support raw SQL execution for security

📋 Please apply this migration manually:

Option 1: Supabase Dashboard SQL Editor
  1. Go to: https://supabase.com/dashboard/project/brejvdvzwshroxkkhmzy/sql/new
  2. Copy the SQL from: supabase/migrations/20260321000001_smartoffice_integration.sql
  3. Paste and run it

Option 2: Supabase CLI
  1. Install Supabase CLI: npm install -g supabase
  2. Link project: supabase link --project-ref brejvdvzwshroxkkhmzy
  3. Push migrations: supabase db push

Option 3: Use this script output (COPY BELOW):
